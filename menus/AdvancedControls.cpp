...
void CAdvancedControls::_Init( void )
{
	...
	invertMouse.SetCoord( BASE_OFFSET_X, 310 );
	...
	mouseLook.SetCoord( BASE_OFFSET_X, 360 );
	...
	lookSpring.SetCoord( BASE_OFFSET_X, 410 );
	...
	//inputDev.SetRect( BASE_OFFSET_X, 230, UI_BUTTONS_WIDTH, UI_BUTTONS_HEIGHT );
	inputDev.SetCoord( BASE_OFFSET_X, 210 );
